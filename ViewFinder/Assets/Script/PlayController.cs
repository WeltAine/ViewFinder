...
public class PlayController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isSwitchScene)
        {
            ...
            playerCamera.transform.Rotate(-playerLook.y * Vector3.right * mouseYSensitivity, Space.Self);//鼠标上下改变相机朝向
            this.transform.Rotate(playerLook.x * Vector3.up * mouseXSensitivity, Space.Self);//鼠标左右改变身体朝向
